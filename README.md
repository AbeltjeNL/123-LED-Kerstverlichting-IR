...
Het [ESPhome YAML bestand](https://github.com/AbeltjeNL/123-LED-Kerstverlichting-IR/blob/main/esphome_example.yaml) /] geeft je de basis, plus een aantal extra sensoren.
